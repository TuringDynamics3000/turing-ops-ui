...
// Mock ledger data
const MOCK_ACCOUNTS = [
  { accountId: "ACC-001-AUD", name: "Operating Account", currency: "AUD", postedBalance: 2847500.00, availableBalance: 2697500.00, holdAmount: 150000.00, lastActivity: new Date(Date.now() - 1800000), status: "ACTIVE" as const },
  { accountId: "ACC-002-AUD", name: "Settlement Account", currency: "AUD", postedBalance: 5850000.00, availableBalance: 5750000.00, holdAmount: 100000.00, lastActivity: new Date(Date.now() - 3600000), status: "ACTIVE" as const },
  { accountId: "ACC-003-AUD", name: "Reserve Account", currency: "AUD", postedBalance: 750000.00, availableBalance: 750000.00, holdAmount: 0, lastActivity: new Date(Date.now() - 86400000), status: "ACTIVE" as const },
  { accountId: "ACC-004-AUD", name: "Payroll Account", currency: "AUD", postedBalance: 425000.00, availableBalance: 425000.00, holdAmount: 0, lastActivity: new Date(Date.now() - 172800000), status: "ACTIVE" as const },
  { accountId: "ACC-005-AUD", name: "Tax Holding Account", currency: "AUD", postedBalance: 312500.00, availableBalance: 312500.00, holdAmount: 0, lastActivity: new Date(Date.now() - 259200000), status: "ACTIVE" as const },
  { accountId: "ACC-006-AUD", name: "Client Trust Account", currency: "AUD", postedBalance: 1875000.00, availableBalance: 1825000.00, holdAmount: 50000.00, lastActivity: new Date(Date.now() - 7200000), status: "ACTIVE" as const },
  { accountId: "ACC-007-AUD", name: "FX Settlement Account", currency: "AUD", postedBalance: 980000.00, availableBalance: 980000.00, holdAmount: 0, lastActivity: new Date(Date.now() - 14400000), status: "ACTIVE" as const },
  { accountId: "ACC-008-AUD", name: "Nostro - CBA", currency: "AUD", postedBalance: 2150000.00, availableBalance: 2150000.00, holdAmount: 0, lastActivity: new Date(Date.now() - 21600000), status: "ACTIVE" as const },
];

const MOCK_HOLDS = [
  { holdId: "HLD-2024-001", accountId: "ACC-001-AUD", amount: 50000.00, currency: "AUD", reason: "Pending payment approval - BHP Billiton", createdAt: new Date(Date.now() - 3600000), expiresAt: new Date(Date.now() + 82800000), linkedDecision: "DEC-2024-001", status: "ACTIVE" as const },
  { holdId: "HLD-2024-002", accountId: "ACC-001-AUD", amount: 75000.00, currency: "AUD", reason: "Pending limit override - Rio Tinto", createdAt: new Date(Date.now() - 7200000), expiresAt: new Date(Date.now() + 79200000), linkedDecision: "DEC-2024-002", status: "ACTIVE" as const },
  { holdId: "HLD-2024-003", accountId: "ACC-001-AUD", amount: 25000.00, currency: "AUD", reason: "AML review - Suspicious pattern", createdAt: new Date(Date.now() - 14400000), expiresAt: new Date(Date.now() + 72000000), linkedDecision: "DEC-2024-003", status: "ACTIVE" as const },
  { holdId: "HLD-2024-004", accountId: "ACC-002-AUD", amount: 100000.00, currency: "AUD", reason: "Settlement hold - Westpac batch", createdAt: new Date(Date.now() - 1800000), expiresAt: new Date(Date.now() + 84600000), linkedDecision: "DEC-2024-004", status: "ACTIVE" as const },
  { holdId: "HLD-2024-005", accountId: "ACC-006-AUD", amount: 50000.00, currency: "AUD", reason: "Client disbursement pending", createdAt: new Date(Date.now() - 10800000), expiresAt: new Date(Date.now() + 75600000), linkedDecision: "DEC-2024-005", status: "ACTIVE" as const },
  { holdId: "HLD-2024-006", accountId: "ACC-001-AUD", amount: 0, currency: "AUD", reason: "Released - Payment completed", createdAt: new Date(Date.now() - 86400000), expiresAt: new Date(Date.now() - 3600000), linkedDecision: "DEC-2024-010", status: "RELEASED" as const },
  { holdId: "HLD-2024-007", accountId: "ACC-002-AUD", amount: 0, currency: "AUD", reason: "Released - Settlement cleared", createdAt: new Date(Date.now() - 172800000), expiresAt: new Date(Date.now() - 86400000), linkedDecision: "DEC-2024-011", status: "RELEASED" as const },
];

const MOCK_POSTINGS = [
  // Today's transactions
  { postingId: "POST-2024-0847", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 5200.00, currency: "AUD", description: "BPAY - Telstra", timestamp: new Date(Date.now() - 1800000), executionRef: "BPAY-2024-0847291" },
  { postingId: "POST-2024-0848", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 12500.00, currency: "AUD", description: "Supplier Payment - BHP Billiton", timestamp: new Date(Date.now() - 2400000), executionRef: "NPP-2024-8472931" },
  { postingId: "POST-2024-0849", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 45000.00, currency: "AUD", description: "Client Receipt - Westpac Corporate", timestamp: new Date(Date.now() - 3000000), executionRef: "NPP-2024-8472932" },
  { postingId: "POST-2024-0850", accountId: "ACC-002-AUD", type: "CREDIT" as const, amount: 250000.00, currency: "AUD", description: "Settlement Batch - Morning Run", timestamp: new Date(Date.now() - 3600000), executionRef: "SETTLE-2024-AM-002" },
  { postingId: "POST-2024-0851", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 8750.00, currency: "AUD", description: "BPAY - AGL Energy", timestamp: new Date(Date.now() - 4200000), executionRef: "BPAY-2024-0847292" },
  { postingId: "POST-2024-0852", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 3200.00, currency: "AUD", description: "Direct Debit - Insurance Australia Group", timestamp: new Date(Date.now() - 4800000), executionRef: "DD-2024-9182736" },
  { postingId: "POST-2024-0853", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 67500.00, currency: "AUD", description: "Wire Transfer - Rio Tinto Ltd", timestamp: new Date(Date.now() - 5400000), executionRef: "WIRE-2024-7362514" },
  { postingId: "POST-2024-0854", accountId: "ACC-002-AUD", type: "DEBIT" as const, amount: 125000.00, currency: "AUD", description: "Outbound Settlement - CBA", timestamp: new Date(Date.now() - 6000000), executionRef: "SETTLE-2024-OUT-001" },
  { postingId: "POST-2024-0855", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 15800.00, currency: "AUD", description: "Payroll - December Week 3", timestamp: new Date(Date.now() - 6600000), executionRef: "PAY-2024-DEC-W3" },
  { postingId: "POST-2024-0856", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 28900.00, currency: "AUD", description: "Client Receipt - Woolworths Group", timestamp: new Date(Date.now() - 7200000), executionRef: "NPP-2024-8472933" },
  // More recent transactions
  { postingId: "POST-2024-0857", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 42000.00, currency: "AUD", description: "Supplier Payment - Wesfarmers", timestamp: new Date(Date.now() - 7800000), executionRef: "NPP-2024-8472934" },
  { postingId: "POST-2024-0858", accountId: "ACC-003-AUD", type: "CREDIT" as const, amount: 100000.00, currency: "AUD", description: "Reserve Transfer - Monthly Top-up", timestamp: new Date(Date.now() - 8400000), executionRef: "INT-2024-RES-001" },
  { postingId: "POST-2024-0859", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 6500.00, currency: "AUD", description: "BPAY - Origin Energy", timestamp: new Date(Date.now() - 9000000), executionRef: "BPAY-2024-0847293" },
  { postingId: "POST-2024-0860", accountId: "ACC-002-AUD", type: "CREDIT" as const, amount: 180000.00, currency: "AUD", description: "Settlement Batch - Afternoon Run", timestamp: new Date(Date.now() - 9600000), executionRef: "SETTLE-2024-PM-001" },
  { postingId: "POST-2024-0861", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 95000.00, currency: "AUD", description: "Wire Transfer - Macquarie Group", timestamp: new Date(Date.now() - 10200000), executionRef: "WIRE-2024-7362515" },
  { postingId: "POST-2024-0862", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 22400.00, currency: "AUD", description: "Supplier Payment - Telstra Corp", timestamp: new Date(Date.now() - 10800000), executionRef: "NPP-2024-8472935" },
  { postingId: "POST-2024-0863", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 4800.00, currency: "AUD", description: "Direct Debit - Medibank Private", timestamp: new Date(Date.now() - 11400000), executionRef: "DD-2024-9182737" },
  { postingId: "POST-2024-0864", accountId: "ACC-002-AUD", type: "DEBIT" as const, amount: 75000.00, currency: "AUD", description: "Outbound Settlement - NAB", timestamp: new Date(Date.now() - 12000000), executionRef: "SETTLE-2024-OUT-002" },
  { postingId: "POST-2024-0865", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 38500.00, currency: "AUD", description: "Client Receipt - Coles Group", timestamp: new Date(Date.now() - 12600000), executionRef: "NPP-2024-8472936" },
  { postingId: "POST-2024-0866", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 18200.00, currency: "AUD", description: "Supplier Payment - Qantas Airways", timestamp: new Date(Date.now() - 13200000), executionRef: "NPP-2024-8472937" },
  // Yesterday's transactions
  { postingId: "POST-2024-0830", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 125000.00, currency: "AUD", description: "Wire Transfer - ANZ Banking", timestamp: new Date(Date.now() - 86400000), executionRef: "WIRE-2024-7362510" },
  { postingId: "POST-2024-0831", accountId: "ACC-002-AUD", type: "CREDIT" as const, amount: 320000.00, currency: "AUD", description: "Settlement Batch - End of Day", timestamp: new Date(Date.now() - 90000000), executionRef: "SETTLE-2024-EOD-001" },
  { postingId: "POST-2024-0832", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 55000.00, currency: "AUD", description: "Supplier Payment - CSL Limited", timestamp: new Date(Date.now() - 93600000), executionRef: "NPP-2024-8472920" },
  { postingId: "POST-2024-0833", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 9800.00, currency: "AUD", description: "BPAY - Optus", timestamp: new Date(Date.now() - 97200000), executionRef: "BPAY-2024-0847280" },
  { postingId: "POST-2024-0834", accountId: "ACC-003-AUD", type: "DEBIT" as const, amount: 50000.00, currency: "AUD", description: "Reserve Withdrawal - Liquidity", timestamp: new Date(Date.now() - 100800000), executionRef: "INT-2024-RES-002" },
  { postingId: "POST-2024-0835", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 72000.00, currency: "AUD", description: "Client Receipt - Transurban", timestamp: new Date(Date.now() - 104400000), executionRef: "NPP-2024-8472921" },
  { postingId: "POST-2024-0836", accountId: "ACC-002-AUD", type: "DEBIT" as const, amount: 200000.00, currency: "AUD", description: "Outbound Settlement - Westpac", timestamp: new Date(Date.now() - 108000000), executionRef: "SETTLE-2024-OUT-003" },
  { postingId: "POST-2024-0837", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 31500.00, currency: "AUD", description: "Supplier Payment - Brambles Ltd", timestamp: new Date(Date.now() - 111600000), executionRef: "NPP-2024-8472922" },
  { postingId: "POST-2024-0838", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 48000.00, currency: "AUD", description: "Wire Transfer - Scentre Group", timestamp: new Date(Date.now() - 115200000), executionRef: "WIRE-2024-7362511" },
  { postingId: "POST-2024-0839", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 7200.00, currency: "AUD", description: "Direct Debit - Suncorp Group", timestamp: new Date(Date.now() - 118800000), executionRef: "DD-2024-9182730" },
  // Older transactions
  { postingId: "POST-2024-0820", accountId: "ACC-002-AUD", type: "CREDIT" as const, amount: 450000.00, currency: "AUD", description: "Settlement Batch - Weekly", timestamp: new Date(Date.now() - 172800000), executionRef: "SETTLE-2024-WK-001" },
  { postingId: "POST-2024-0821", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 85000.00, currency: "AUD", description: "Supplier Payment - Fortescue Metals", timestamp: new Date(Date.now() - 176400000), executionRef: "NPP-2024-8472910" },
  { postingId: "POST-2024-0822", accountId: "ACC-001-AUD", type: "CREDIT" as const, amount: 165000.00, currency: "AUD", description: "Wire Transfer - Woodside Energy", timestamp: new Date(Date.now() - 180000000), executionRef: "WIRE-2024-7362505" },
  { postingId: "POST-2024-0823", accountId: "ACC-003-AUD", type: "CREDIT" as const, amount: 200000.00, currency: "AUD", description: "Reserve Transfer - Quarterly", timestamp: new Date(Date.now() - 259200000), executionRef: "INT-2024-RES-003" },
  { postingId: "POST-2024-0824", accountId: "ACC-001-AUD", type: "DEBIT" as const, amount: 145000.00, currency: "AUD", description: "Payroll - December Week 2", timestamp: new Date(Date.now() - 604800000), executionRef: "PAY-2024-DEC-W2" },
];
